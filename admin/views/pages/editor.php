...
<div class="container-no-margin">
    <form method="post" data-form="page-editor-form" enctype="multipart/form-data">
        <div class="row">
            <div class="col-l-3-4">
                <div class="component">
                    <h3 class="caption"><?= $this->translate('pages.content') ?></h3>
...
?>
                    <div class="page-info">
                        <?php if (!$page->isIndexPage() && !$page->isErrorPage()): ?>
                            <div class="page-route page-route-changeable">
                                <button type="button" class="page-slug-change" data-command="change-slug" title="<?= $this->translate('pages.change-slug') ?>"><?= $page->route() ?></button>
                            </div>
                        <?php else: ?>
                    ...
                    <div class="editor-wrap">
                        <div class="editor-toolbar" data-for="content">
                            <button type="button" class="toolbar-button" data-command="bold" title="<?= $this->translate('pages.editor.bold') ?>"><span class="i-bold"></span></button>
                            <button type="button" class="toolbar-button" data-command="italic" title="<?= $this->translate('pages.editor.italic') ?>"><span class="i-italic"></span></button>
                            <button type="button" class="toolbar-button" data-command="ul" title="<?= $this->translate('pages.editor.bullet-list') ?>"><span class="i-list-ul"></span></button>
                            <button type="button" class="toolbar-button" data-command="ol" title="<?= $this->translate('pages.editor.numbered-list') ?>"><span class="i-list-ol"></span></button>
                            <span class="spacer"></span>
                            <button type="button" class="toolbar-button" data-command="quote" title="<?= $this->translate('pages.editor.quote') ?>"><span class="i-quote"></span></button>
                            <button type="button" class="toolbar-button" data-command="link" title="<?= $this->translate('pages.editor.link') ?>"><span class="i-link"></span></button>
                            <button type="button" class="toolbar-button" data-command="image" title="<?= $this->translate('pages.editor.image') ?>"><span class="i-image"></span></button>
                            <button type="button" class="toolbar-button" data-command="summary" title="<?= $this->translate('pages.editor.summary') ?>"><span class="i-read-more"></span></button>
                            <span class="spacer"></span>
                            <button type="button" class="toolbar-button" data-command="undo" title="<?= $this->translate('pages.editor.undo') ?>" disabled><span class="i-undo"></span></button>
                            <button type="button" class="toolbar-button" data-command="redo" title="<?= $this->translate('pages.editor.redo') ?>" disabled><span class="i-redo"></span></button>
                        </div>
                        <textarea class="editor-textarea" id="content" name="content" autocomplete="off"><?= $this->escape($page->rawContent()) ?></textarea>
                    </div>
                    <input type="hidden" name="csrf-token" value="<?= $csrfToken ?>">
                    <button type="submit" class="button-accent button-right" data-command="save"><i class="i-check"></i> <?= $this->translate('pages.save') ?></button>
<?php
                    if ($availableLanguages):
?>
                    <div class="dropdown button-right">
                        <button type="button" class="dropdown-button button-accent" data-dropdown="languages-dropdown"><i class="i-language"></i> <?= $this->translate('pages.languages') ?><?php if ($currentLanguage): ?> <span class="page-language"><?= $currentLanguage ?></span><?php endif; ?></button>
...
?>
                <div class="component">
                    <h3 class="caption"><?= $this->translate('pages.files') ?></h3>
                    <ul class="files-list">
<?php
...
?>
            ...
            <div class="col-l-1-4">
                <div class="component">
                    <h3 class="caption"><?= $this->translate('pages.options') ?></h3>
                    <?= $fields ?>
                </div>
                <div class="component">
                    <h3 class="caption"><?= $this->translate('pages.attributes') ?></h3>
                    <label for="page-parent"><?= $this->translate('pages.parent') ?>:</label>
...
?>
                    ...
                    <label for="page-template"><?= $this->translate('pages.template') ?>:</label>
