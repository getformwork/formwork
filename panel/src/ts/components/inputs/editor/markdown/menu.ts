...
export function menuPlugin(id: string) {
    ...
    const items = [
        {
            name: app.translation.get("panel.editor.paragraph", "Paragraph"),
            command: setBlockType(schema.nodes.paragraph),
            dom: createMenuItem(app.translation.get("panel.editor.paragraph", "Paragraph")),
            dropdown: "editor-level",
            group: "style",
        },
        {
            name: app.translation.get("panel.editor.code", "Code"),
            node: schema.nodes.code_block,
            command: setBlockType(schema.nodes.code_block),
            dom: createMenuItem(`<span class="text-monospace">${app.translation.get("panel.editor.code", "Code")}</span>`),
            dropdown: "editor-level",
            group: "style",
        },
        {
            name: app.translation.get("panel.editor.heading1", "Heading 1"),
            command: setBlockType(schema.nodes.heading, { level: 1 }),
            dom: createMenuItem(`<span class="h1">${app.translation.get("panel.editor.heading1", "Heading 1")}</span>`),
            dropdown: "editor-level",
            group: "style",
        },
        {
            name: app.translation.get("panel.editor.heading2", "Heading 2"),
            command: setBlockType(schema.nodes.heading, { level: 2 }),
            dom: createMenuItem(`<span class="h2">${app.translation.get("panel.editor.heading2", "Heading 2")}</span>`),
            dropdown: "editor-level",
            group: "style",
        },
        {
            name: app.translation.get("panel.editor.heading3", "Heading 3"),
            command: setBlockType(schema.nodes.heading, { level: 3 }),
            dom: createMenuItem(`<span class="h3">${app.translation.get("panel.editor.heading3", "Heading 3")}</span>`),
            dropdown: "editor-level",
            group: "style",
        },
        {
            name: app.translation.get("panel.editor.heading4", "Heading 4"),
            command: setBlockType(schema.nodes.heading, { level: 4 }),
            dom: createMenuItem(`<span class="h4">${app.translation.get("panel.editor.heading4", "Heading 4")}</span>`),
            dropdown: "editor-level",
            group: "style",
        },
        {
            name: app.translation.get("panel.editor.heading5", "Heading 5"),
            command: setBlockType(schema.nodes.heading, { level: 5 }),
            dom: createMenuItem(`<span class="h5">${app.translation.get("panel.editor.heading5", "Heading 5")}</span>`),
            dropdown: "editor-level",
            group: "style",
        },
        {
            name: app.translation.get("panel.editor.heading6", "Heading 6"),
            command: setBlockType(schema.nodes.heading, { level: 6 }),
            dom: createMenuItem(`<span class="h6">${app.translation.get("panel.editor.heading6", "Heading 6")}</span>`),
            dropdown: "editor-level",
            group: "style",
        },
        {
            ...
            dom: createButton("bold", app.translation.get("panel.editor.bold", "Bold")),
            group: "style",
        },
        {
            mark: schema.marks.em,
            command: toggleMark(schema.marks.em),
            dom: createButton("italic", app.translation.get("panel.editor.italic", "Italic")),
            group: "style",
        },
        {
            mark: schema.marks.code,
            command: toggleMark(schema.marks.code),
            dom: createButton("code", app.translation.get("panel.editor.code", "Code")),
            group: "style",
        },
        {
            command: wrapInList(schema.nodes.bullet_list, schema.nodes.list_item),
            dom: createButton("listUnordered", app.translation.get("panel.editor.bulletList", "Bullet list")),
            group: "blocks",
        },
        {
            command: wrapInList(schema.nodes.ordered_list, schema.nodes.list_item),
            dom: createButton("listOrdered", app.translation.get("panel.editor.numberedList", "Numbered list")),
            group: "blocks",
        },
        {
            node: schema.nodes.blockquote,
            command: wrapIn(schema.nodes.blockquote),
            dom: createButton("blockquote", app.translation.get("panel.editor.quote", "Quote")),
            group: "blocks",
        },
        {
            command: sinkListItem(schema.nodes.list_item),
            dom: createButton("indentIncrease", app.translation.get("panel.editor.increaseIndent", "Increase indent")),
            group: "blocks",
        },
        {
            command: lift,
            dom: createButton("indentDecrease", app.translation.get("panel.editor.decreaseIndent", "Decrease indent")),
            group: "blocks",
        },
        {
            node: schema.nodes.image,
            command: insertImage,
            dom: createButton("image", app.translation.get("panel.editor.image", "Image")),
            group: "media",
        },
        {
            mark: schema.marks.link,
            command: insertLink,
            dom: createButton("link", app.translation.get("panel.editor.link", "Link")),
            group: "media",
        },
        {
            command: undo,
            dom: createButton("rotateLeft", app.translation.get("panel.editor.undo", "Undo")),
        },
        {
            command: redo,
            dom: createButton("rotateRight", app.translation.get("panel.editor.redo", "Redo")),
        },
    ];
