...
export default function DateInput(input, options) {
    ...
    function setCalendarPosition() {
        ...
        const calendarTop = calendarRect.top + window.pageYOffset;
        const calendarLeft = calendarRect.left + window.pageXOffset;
        const calendarWidth = Utils.outerWidth(calendarElement);
        const calendarHeight = Utils.outerHeight(calendarElement);
